...
exports.crearUsuario = async (req, res) => {
  try {
    const { nombre, correo, telefono, pass, respuesta } = req.body;
    const preguntaIndex = req.body.pregunta; // Índice de la pregunta seleccionada
    const preguntaSeleccionada = preguntas[preguntaIndex].label;
